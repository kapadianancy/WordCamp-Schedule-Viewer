...
import { eventClick, fillEvents, Run } from '../../../public/assets/js/custom-calendar'
                    ...
                    <div className="fc-toolbar fc-header-toolbar">
                        <div className="fc-left">
                            <div className="fc-button-group">
                                <button type="button" onClick={btnClick} className="fc-prev-button fc-button fc-button-primary"
